...
const faqs = [
  {
    ...
    a: "From sign-up to live calls, the process typically takes a few days. The majority of that time is spent building and training your AI on your specific business information. The technical phone forwarding step takes under 10 minutes."
  },
  {
...
export default function FaqPage() {
  ...
  return (
    <>
      ...
      <section className="section-padding section-white container" style={{ paddingTop: "10rem", minHeight: "60vh" }}>
        <Reveal>
      ...
      <section className="section-padding section-alt container" style={{ textAlign: "center" }}>
        <Reveal>
          ...
          <p className="body-text" style={{ margin: "0 auto 2rem" }}>
            Book a demo or consultation and we&rsquo;ll answer any technical or service questions you might have.
          </p>
          <div className="cta-row">
            <Link href="/book" className="btn rounded-full">Book Consultation &rarr;</Link>
            <a href="tel:+442039960962" className="btn-outline">Call 020 3996 0962</a>
          </div>
        </Reveal>
      </section>
