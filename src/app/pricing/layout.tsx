...
export const metadata: Metadata = {
  ...
  description: "Transparent AI receptionist pricing. Managed service from £197/mo or one-off build from £997. No contracts or lock-ins. 24/7 call answering for UK businesses.",
