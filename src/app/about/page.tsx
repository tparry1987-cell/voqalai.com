...
const CREW = [
  ...
  { name: "Adrian Wilkinson", role: "Strategic Partnerships Director", bio: "Adrian was one of Voqal AI's first clients, originally working with us on an AI website and voice agent for his real estate business. Impressed by the results, he came on board as a strategic partner and now helps other businesses identify where AI and automation can improve customer experience, communication, and day-to-day operations.", img: "/images/avatars/adrian-wilkinson.webp" },
