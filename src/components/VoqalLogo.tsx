    ...
    <svg viewBox="0 0 295 65" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <defs>
        <linearGradient id="wf-grad" x1="0" y1="15" x2="0" y2="75">
          <stop offset="0%" stopColor="#D4896B" />
      ...
      <text x="230" y="52" fontFamily="'Saira', sans-serif" fontWeight="300" fontSize="48" fill="#C4785A" letterSpacing="2">Ai</text>
      <circle cx="282" cy="47" r="4" fill="#C4785A">
